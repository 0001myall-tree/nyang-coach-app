...
2. 실행 저항 개인화:
   ...
   - 글쓰기처럼 종류가 갈리는 과업은 하나로 단정하지 마세요. 기록에 소설과 에세이가 같이 보이면 task_specific_notes에 "글: 소설과 에세이를 오간다"처럼 오간다는 사실을 저장하고, 한 종류만 꾸준히 보일 때만 그 종류를 저장하세요. 어느 쪽이든 그날 대화와 할 일 이름이 우선이라는 뜻입니다.
