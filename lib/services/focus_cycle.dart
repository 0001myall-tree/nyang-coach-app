...
class FocusCycleSetting {
  ...
  ///
  /// 40·45·50이 10분 안에 몰려 있어 고르는 사람에게는 같은 값이나 다름없었다.
  /// 50만 남겼고, 15와 25 사이에 끼어 있던 20도 뺐다. 위로는 90까지 연다 — 각성도가 대략 90분 주기로 오르내린다는
  /// 얘기가 있어, 25분이 안 맞는 사람에게 줄 다른 축이 된다.
  ///
  /// 120은 넣지 않았다. 못 시작하는 사람을 돕는 앱에서 2시간 버튼은 방향이
  /// 어긋나고, 정 필요하면 60분 두 번이 중간 휴식까지 끼워서 더 오래 간다.
  static const List<int> workChoices = [10, 15, 25, 30, 50, 60, 90];
