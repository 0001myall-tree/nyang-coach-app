...
class MasterGreetingCopy {
  ...
  static const secretary = GreetingVoice(
    ...
    earlyEveningNone: [
      '아직 늦지 않았습니다. 하나만 하셔도 기분이 달라지실 거예요.',
      '{저녁은 이제 시작이니|이제 막 저녁이 됐으니} 지금 하나만 하셔도 충분히 좋을 것 같습니다.',
      // 뭘 하면 되는지 되묻지 않고 기준을 박아준다. 고를 일정은 카드가 보여준다.
      '오늘이 아직 {끝난 게 아닙니다|남아 있습니다}. {가벼운 거|작은 거} 하나만 해도 충분합니다.',
    ],
  ...
  static const nyangHalbae = GreetingVoice(
    ...
    earlyEveningNone: [
      '아직 안 늦었다냥. 하나만 해도 기분이 달라질 거다냥.',
      '{저녁은 이제 시작이니|이제 막 저녁이 됐으니} 지금 하나만 해도 충분히 좋을 것 같다냥.',
      '오늘이 아직 {끝난 게 아니다냥|남아 있다냥}. {가벼운 거|작은 거} 하나만 해도 충분하다냥.',
    ],
    earlyEveningHigh: [
