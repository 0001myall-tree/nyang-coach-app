...
class MasterGreetingCopy {
  ...
  static const secretary = GreetingVoice(
    ...
    typeAdviceNoPlan: {
      ...
      '계획 편차형': [
        '완벽하게 채우려 하지 마시고 딱 하나만 적어보시죠. 적어두신 날은 잘해내시니까요.',
      ],
      '시작 편차형': [
        '하나만 적고 작게 5분만 시작해보세요. 일단 시작하면 그 이후는 훨씬 평탄해집니다.',
      ],
      '계획 과다형': [
        '오늘은 욕심 없이 하나만 적어보시죠. 적게 잡으신 날이 오히려 끝까지 가더라고요.',
      ],
      '시작 꾸준형': [
        "하나만 적으시되 '어디까지면 끝'인지도 같이 적어두시죠. 손대는 건 늘 하시니 끝만 정하면 됩니다.",
      ],
      '무난형': ['오늘은 하나만 적어두셔도 충분해요. 망설이는 시간만 줄이시면 나머지는 따라옵니다.'],
      '자유형': [
        '부담 갖지 마시고 오늘 하나만 정해보시죠. 욕심 없이 최소치 기준 하나만 정해볼까요?',
      ],
      '벼락치기형': [
  ...
  static const nyangHalbae = GreetingVoice(
    ...
    typeAdviceNoPlan: {
      ...
      '계획 편차형': [
        '완벽하게 채우려 말고 딱 하나만 적어보자. 적어둔 날은 잘해내니까냥.',
      ],
      '시작 편차형': [
        '하나만 적고 작게 5분만 시작해보자. 일단 시작하면 그 뒤는 훨씬 평탄해진다냥.',
      ],
      '계획 과다형': [
        '오늘은 욕심 없이 하나만 적어보자. 적게 잡은 날이 오히려 끝까지 가더라냥.',
      ],
      '시작 꾸준형': [
        "하나만 적되 '어디까지면 끝'인지도 같이 적어두자. 손대는 건 늘 하니 끝만 정하면 된다냥.",
      ],
      '무난형': ['오늘은 하나만 적어둬도 충분하다. 망설이는 시간만 줄이면 나머지는 따라온다냥.'],
      '자유형': [
        '부담 갖지 말고 오늘 하나만 정해보자. 욕심 없이 최소치 기준 하나만 정해볼까냥?',
      ],
      '벼락치기형': [
