...
class MasterGreetingCopy {
  ...
  static const secretary = GreetingVoice(
    ...
    morningPlan: [
      '오늘 캘린더 일정 {실행하시다가|하시다가} 막히는 점 있으면 {말씀해 주세요|알려주세요}.',
    ...
    afterLateNight: [
      '어제 늦게 주무신 것 같은데 컨디션은 괜찮으신지 모르겠네요. 오늘 캘린더 일정 하시다가 힘든 일 있으면 말씀해 주세요.',
      '어젯밤 늦게까지 깨어 계셨죠. 무리되는 일이 있으면 언제든 알려주세요.',
    ],
    afterSick: [
      '어제 컨디션이 안 좋으셨는데 좀 회복되셨는지 모르겠어요. 오늘 캘린더 일정 하시다가 심리적으로 힘든 일 있으면 알려주세요.',
  ...
  static const nyangHalbae = GreetingVoice(
    ...
    morningPlan: [
      '오늘 캘린더 일정 {하다가|해나가다} 막히는 게 있으면 {말하라냥|알려주라냥}.',
