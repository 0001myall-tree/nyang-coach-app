...
class LifePatternService {
  ...
  ///
  /// 다음 지점은 사용자가 시작했다고 말한 뒤에만 잡는다. 조건을 안 걸면 첫
...
- 부담 없이 시작할 수 있는 첫 조각 하나를 짚어준다. 사용자가 첫 시작을 했다고 말하면 다음 지점을 하나 잡아준다. 정한 분량이 있으면 거기까지 데려가고, 정한 것이 없으면 컨디션을 보며 더 제안할지 멈추고 한 것을 인정해줄지 그때 정한다.
