...
- 부담 없이 시작할 수 있는 첫 조각 하나를 짚어주고, 그걸 해내면 다음 지점을 하나 잡아준다. 정한 분량이 있으면 거기까지 데려가고, 정한 것이 없으면 컨디션을 보며 더 제안할지 멈추고 한 것을 인정해줄지 그때 정한다.
- 컨디션이 좋고 그 일을 할 의지가 있는 만큼 적극적으로 도와준다.''';
  }
