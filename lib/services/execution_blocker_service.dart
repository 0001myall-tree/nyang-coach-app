...
class ExecutionBlockerService {
  ...
  ///
  /// 딴짓은 여기 없다. 그건 막힌 결과이지 막는 것이 아니다 — 무거워서
  /// 도망친 것일 수도, 결과가 두려운 것일 수도, 더 즉각적인 것이 옆에 있는
  /// 것일 수도 있다. 선택지에 두면 원인을 고를 자리를 그것이 차지한다.
  static const Map<String, String> answers = {
    '뭐부터 할지 모르겠어': '무엇부터 손댈지 정하는 데서 막힘. 고를 것이 여럿일 때 못 움직임.',
    '일이 너무 크게 느껴져': '해야 할 것이 크게 다가와 압도됨. 어디부터 손대도 끝이 안 보여서 못 움직임.',
  ...
  static const Map<String, String> _preferred = {
    ...
    // 크게 느껴져 압도된 것이라, 그 일의 제일 작은 한 칸을 짚어 크기를 줄인다.
    '일이 너무 크게 느껴져': 'narrow_scope',
